...
<head>
        <title>首页</title>
        <link href="<?php echo Yii::app()->baseURL; ?>/xhtml/html/docWeb.css" rel="stylesheet" type="text/css" />
        <style type="text/css">
            ul ul{
                visibility: hidden;
                position: absolute;
...
<div class="top">
    <img src="<?php echo Yii::app()->baseURL; ?>/xhtml/html/images/temp_pic.jpg" height="250" width="300" />
</div>
